        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="/dashboard/konsultasi-medis/{{ $konsultasi->id }}" method="POST" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <div class="mb-5">
                            <label for="tanggal_konsultasi" class="block mb-2 text-sm font-medium text-gray-900">Tanggal Konsultasi</label>
                            <input type="date" id="tanggal_konsultasi" name="tanggal_konsultasi" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Tanggal Konsultasi" value="{{ old('tanggal_konsultasi', $konsultasi->tanggal_konsultasi) }}" required />
                        ...
                        <div class="mb-5">
                            ...
                            <input id="keluhan" type="hidden" name="keluhan" value="{{ old('keluhan', $konsultasi->keluhan) }}">
